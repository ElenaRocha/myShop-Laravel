<x-layout :title="__('messages.nav.offers')">
    <div class="container mx-auto px-6 py-8">
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900 mb-4">{{ __('messages.buttons.special_offers') }}</h1>
            <p class="text-gray-600">{{ __('messages.pages.offers_subtitle') }}</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            @empty
                <div class="col-span-full text-center py-12">
                    <p class="text-gray-500 text-lg">{{ __('messages.empty.offers') }}</p>
                    </div>
            @endforelse
                </div>
    </div>
